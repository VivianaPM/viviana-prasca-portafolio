...
¡Hola! Soy [Tu Nombre], [tu título profesional, ej: Desarrollador Full Stack / Ingeniero de Software].

## Sobre Mí

[Breve descripción sobre ti, tu experiencia, tus áreas de especialización y qué te apasiona. Máximo 3-4 líneas.]

## Proyectos Destacados

Aquí encontrarás una selección de mis proyectos más relevantes, organizados por área de especialización.
...
- **[Hubentory](proyecto-hubentory/hubentory.md)**: [Descripción breve del desarrollo backend de la API].

## Contacto

- **LinkedIn**: [Mi perfil de LinkedIn](https://www.linkedin.com/in/vprascam)
- **GitHub**: [VivianaPM](https://github.com/VivianaPM)
- **Email**: [tu@email.com](mailto:tu@email.com)

---

_Este portafolio fue construido con MkDocs y Material for MkDocs._
